package com.sandboxspringsecurity.configurer;

import com.sandboxspringsecurity.converter.JwtAuthenticationConverter;
import com.sandboxspringsecurity.filter.JwtLogoutFilter;
import com.sandboxspringsecurity.filter.RefreshTokenFilter;
import com.sandboxspringsecurity.filter.RequestJwtTokensFilter;
import com.sandboxspringsecurity.entity.Token;
import com.sandboxspringsecurity.service.TokenAuthenticationUserDetailsService;
...
public class JwtAuthenticationConfigurer
    ...
    public void configure(HttpSecurity builder) throws Exception {
        ...
        jwtAuthenticationFilter.setFailureHandler((request, response, exception) -> response
